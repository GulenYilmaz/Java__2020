...
public class Recap {
	...
	public static void main(String[] args) {
		 String[][] groceries={
	        ...
	        for(String[] array:groceries) { //---> burada [] kullaniyoruz cunku array icindeki diger arraylari bulmak icin
	            //loop through each single array
	            for(String items:array) {// ---> burada [] kullanmiyoruz array icindekileri yazdigimiz icin 
